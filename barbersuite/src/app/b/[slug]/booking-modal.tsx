              ...
              <div className="space-y-3">
                {services.map(service => (
                  <button 
                    ...
                    className="w-full p-4 rounded-xl border border-neutral-800 bg-neutral-900/50 hover:border-[#d4af37] hover:bg-[#d4af37]/5 transition-all text-left flex justify-between items-center group"
                  >
                    <div>
                      <p className="text-white font-medium group-hover:text-[#d4af37] transition-colors">{service.name}</p>
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button 
                  ...
                  className="p-4 rounded-xl border border-neutral-800 bg-neutral-900/50 hover:border-[#d4af37] hover:bg-[#d4af37]/5 transition-all flex flex-col items-center gap-3"
                >
                ...
                {barbers.map(barber => (
                  <button 
                    ...
                    className="p-4 rounded-xl border border-neutral-800 bg-neutral-900/50 hover:border-[#d4af37] hover:bg-[#d4af37]/5 transition-all flex flex-col items-center gap-3"
                  >
                    <div className="w-16 h-16 relative rounded-full overflow-hidden border-2 border-transparent hover:border-[#d4af37] transition-colors">
                    ...
                    <button
                      ...
                      className={`flex-shrink-0 snap-start w-16 h-20 rounded-xl border flex flex-col items-center justify-center transition-all ${
                        isSelected 
                          ...
                          : 'border-neutral-800 bg-neutral-900/50 text-white hover:border-[#d4af37]/50'
                      }`}
                    >
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="space-y-4">
                ...
                <button 
                  ...
                  className="btn-gold w-full justify-center mt-4 py-3 disabled:opacity-50"
                >
                  Continuar
                </button>
              </div>
            ...
            <div className="animate-fade-in-up flex flex-col h-full">
              ...
              <div className="flex-1 space-y-4">
                <div className="p-4 rounded-xl bg-neutral-900 border border-neutral-800 space-y-3">
                  <div className="flex items-start gap-3">
                    <Scissors className="text-[#d4af37] mt-1" size={18} />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <User className="text-[#d4af37] mt-1" size={18} />
                    <div>
              ...
              <div className="mt-6 pt-4 border-t border-neutral-800">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-[#d4af37] font-bold text-xl">{formatCurrency(selectedService?.price)}</span>
                </div>
                <button 
