...
const KPIs = [
  ...
  { label: 'Taxa de Abertura', value: '43%', icon: MessageSquare, color: 'text-[#ffffff]' },
    ...
    <div className="flex flex-col gap-8 p-6 min-h-full relative" style={{ background: '#030303' }}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="font-[family-name:var(--font-display)] text-3xl font-bold text-white uppercase tracking-tight">
            Campanhas de <span className="text-[#ffffff]">Marketing</span>
          </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {CAMPAIGNS.map(camp => {
          ...
          if (camp.status === 'Agendada') badgeColor = 'bg-[#ffffff]/10 text-[#ffffff] border-[#ffffff]/20'
            ...
            <div key={camp.id} className="premium-card p-6 flex flex-col gap-4">
              ...
              <div className="border-t border-white/5 pt-4">
                ...
                {camp.status === 'Enviada' && (
                  <div className="mt-4">
                    <div className="flex justify-between text-xs mb-1">
                      <span className="text-[#ffffff] font-bold">Abertura</span>
                      <span className="text-white font-bold">{camp.openRate}%</span>
                    </div>
                    <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                      <div className="h-full bg-[#ffffff]" style={{ width: `${camp.openRate}%` }} />
                    </div>
                  </div>
                )}
              </div>
        ...
        <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-sm transition-all duration-300">
          <div className="w-full md:w-[600px] h-full bg-[#0a0a0a] border-l border-neutral-800 shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <div className="p-6 border-b border-neutral-800 flex justify-between items-center bg-[#030303]">
              <h2 className="font-[family-name:var(--font-display)] text-xl font-bold text-white uppercase tracking-tight">Criar <span className="text-[#ffffff]">Campanha</span></h2>
              ...
              <div className="flex-1 flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button className="premium-input w-full justify-center bg-[#ffffff]/10 text-[#ffffff] border-[#ffffff]/30 text-sm font-bold">
                      Enviar Agora
                    </button>
