...
const STATUS_CONFIG = {
  pending: { label: 'Pendente', color: '#d4af37', bg: 'bg-[#d4af37]/10', icon: Clock },
...
export default async function DashboardPage() {
  ...
  const kpis = [
    { label: 'Faturamento Hoje', value: formatCurrency(revenueToday), icon: DollarSign, color: '#d4af37', sub: `${countToday} atendimentos hoje` },
    ...
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Link href="/dashboard/appointments" className="btn-gold text-xs py-2.5 px-4">
            <Plus size={14} />
            Novo Agendamento
          </Link>
      ...
      {barbershop.plan === 'trial' && (
        <div className="bg-[#d4af37]/8 border border-[#d4af37]/25 rounded-2xl p-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#d4af37]/15 flex items-center justify-center flex-shrink-0">
              <span className="text-lg">✨</span>
            </div>
            <div>
              <p className="text-[#d4af37] font-semibold text-sm">Trial Gratuito Ativo</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/dashboard/billing" className="btn-gold text-xs py-2 px-4 whitespace-nowrap">
          ...
          <div className="flex items-end gap-3 h-40">
            {chartData.map((d, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-2 group">
                <span className="text-[9px] text-neutral-600 group-hover:text-[#d4af37] transition-colors">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: d.value > 0
                        ? 'linear-gradient(to top, #d4af37, #f0d98a80)'
                        : '#1a1a1a',
        ...
        <div className="premium-card p-6 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              ...
              className="text-[10px] text-[#d4af37] hover:underline flex items-center gap-1 uppercase tracking-widest"
            >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { href: '/dashboard/services', label: 'Gerenciar Serviços', icon: '✂', color: '#d4af37' },
          ...
          >
            ...
            <ArrowRight size={12} className="ml-auto text-neutral-700 group-hover:text-[#d4af37] transition-colors" />
          </Link>
        ))}
      </div>
    </div>
